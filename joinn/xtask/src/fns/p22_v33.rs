...
pub(crate) fn p22_v33() -> bool {
    ...
    for s in &seals {
        ...
        match joinn_prim::check_v33_full(body, &s.sealed, &floor, s.cell, &seals, &cells, &bodies) {
            Verdict::Ok(()) => {}
    ...
    matches!(joinn_prim::check_seal_dag(&edges), Verdict::Refused(_))
}
